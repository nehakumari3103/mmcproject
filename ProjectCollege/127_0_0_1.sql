...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2025 at 02:51 PM
...
--
-- Error reading structure for table api_database.products: #1932 - Table &#039;api_database.products&#039; doesn&#039;t exist in engine
-- Error reading data for table api_database.products: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near &#039;FROM `api_database`.`products`&#039; at line 1
...
-- Database: `bca_pu`
--
CREATE DATABASE IF NOT EXISTS `bca_pu` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bca_pu`;
...
INSERT INTO `students` (`Roll`, `Name`, `course`, `contact number`, `year`, `city`) VALUES
(1, 'Neha', 'BCA', 912327046, 3, 'Patna'),
(2, 'Awantika', 'MCA', 879710363, 2, 'Delhi'),
(3, 'pallavi', 'B.tech', 840581063, 1, 'Noida'),
(4, 'Riya', 'M.tech', 887782522, 1, 'Begusarai'),
(5, 'Ankita', 'BBA', 810216955, 2, 'Bhopal'),
(6, 'Riya', 'B.com', 970943040, 3, 'Mumbai');
...
--
ALTER TABLE `students`
  MODIFY `Roll` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- Database: `magadh_college`
--
CREATE DATABASE IF NOT EXISTS `magadh_college` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `magadh_college`;
...
-- Database: `neha`
--
CREATE DATABASE IF NOT EXISTS `neha` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `neha`;
...
INSERT INTO `table1` (`cc13`, `cc14`, `DSE1`, `DSE2`) VALUES
(97, 99, 92, 99),
(99, 99, 97, 91),
(0, 0, 0, 0);
--
